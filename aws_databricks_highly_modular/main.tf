...
module "workspace_collection" {
  ...
  workspace_vpce_service  = each.value.workspace_vpce_service
  relay_vpce_service      = each.value.relay_vpce_service
  privatelink_subnets_ids = aws_subnet.privatelink.*.id
